...
CFLAGS_MPI = ['-pthread']
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fvisibility=hidden', '-Wno-array-bounds']
...
DEFINES = ['NS3_BUILD_PROFILE_DEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_MPI=1', 'HAVE_SQLITE3=1', 'HAVE_IF_TUN_H=1', 'HAVE_GSL=1', 'HAVE_CRYPTO=1']
DEFINES_MPI = ['NS3_OPENMPI', 'NS3_MPI']
DEFINES_PYEMBED = ['_FORTIFY_SOURCE=2', 'NDEBUG']
DEFINES_PYEXT = ['_FORTIFY_SOURCE=2', 'NDEBUG']
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'PYTHONDIR': '', 'PYTHONARCHDIR': '', 'HAVE_PYEMBED': '', 'HAVE_PYEXT': '', 'HAVE_PYTHON_H': '', 'HAVE_STDINT_H': '', 'HAVE_GTK': '', 'HAVE_LIBXML2': '', 'HAVE_UINT128_T': '', 'HAVE___UINT128_T': '', 'INT64X64_USE_128': '', 'HAVE_INTTYPES_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_SYS_TYPES_H': '', 'HAVE_SYS_STAT_H': '', 'HAVE_DIRENT_H': '', 'HAVE_STDLIB_H': '', 'HAVE_GETENV': '', 'HAVE_SIGNAL_H': '', 'HAVE_PTHREAD_H': '', 'HAVE_RT': '', 'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_IF_TUN_H': '', 'HAVE_PACKET_H': '', 'HAVE_MPI': '', 'HAVE_SQLITE3': '', 'HAVE_GSL': '', 'HAVE_CRYPTO': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
ENABLE_GSL = '-I/usr/local/include -L/usr/local/lib -lgsl -lgslcblas -lm\n'
...
INCLUDES_GSL = ['/usr/local/include']
...
VALGRIND_FOUND = True
VERSION = '3.29'
WITH_PYBINDGEN = '/mnt/d/Documents/PYTHON/aquasim-ng/aquasim-ng_wsl/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/mnt/d/Documents/PYTHON/aquasim-ng/aquasim-ng_wsl/ns-3.29/build/ns3/config-store-config.h', '/mnt/d/Documents/PYTHON/aquasim-ng/aquasim-ng_wsl/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_SYS_IOCTL_H', 'HAVE_IF_NETS_H', 'HAVE_NET_ETHERNET_H', 'HAVE_IF_TUN_H', 'HAVE_PACKET_H', 'HAVE_MPI', 'HAVE_SQLITE3', 'HAVE_GSL', 'HAVE_CRYPTO']

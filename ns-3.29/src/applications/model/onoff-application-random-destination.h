...
#ifndef ONOFF_APPLICATION_RANDOM_DESTINATION_H
#define ONOFF_APPLICATION_RANDOM_DESTINATION_H
 ...
 * \defgroup onoff OnOffApplicationRandomDestination
 *
...
*/
class OnOffApplicationRandomDestination : public Application
{
public:
  /**
  ...
  OnOffApplicationRandomDestination ();

  virtual ~OnOffApplicationRandomDestination();
...
#endif /* ONOFF_APPLICATION_RANDOM_DESTINATION_H */
